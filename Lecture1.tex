...
\pause
2 Studenten, die finden, dass zu wenig gutes Haskell gelehrt wird.\\
\pause
\vspace*{1cm}
...
\begin{frame}[fragile]
\frametitle{Aufbau der Vorlesung}
\begin{itemize}
 \item 12 Vorlesungen
 \pause
 \item 6 praxisnahe Vorlesungen mit zugehöriger Übung
 \pause
 \item 6 weiterführende Vorlesungen, die euch zeigen, wie tief der Hasenbau wirklich ist
 \pause
 \item Abgabe Einzelprojekt zur Erbringung der Studienleistung
\end{itemize}

Die Bearbeitung der Übungen ist freiwillig - aber im Hinblick auf das Projekt sehr empfehlenswert.\\
Ihr werdet \bf ALLE \normalfont Übungen im Projekt (in abgewandelter Form) praktisch brauchen.
